    ...
    def handle(self, *args, **options):
        ...
        products = [{'name': 'Повелитель мух',
                     ...
                     'description': 'Если лицо совершенно меняется от того, сверху или снизу его осветить, '
                                    ...
                                    'вообще тогда стоит?'},  # Классическая зарубежная проза

                    {'name': 'Убийство в Восточном экспрессе',
                     'purchase_price': 309,
                     'category': categories_for_create[1],
                     'description': 'Невозможное случиться не может, поэтому оно должно стать возможным, '
                                    'несмотря ни на что.'},  # Исторический детектив
                    ...
                    {'name': 'Тонкое искусство пофигизма: Парадоксальный способ жить счастливо',
                     ...
                     'description': 'Знаете, кто строит всю жизнь на эмоциях? Трехлетние дети. И собаки. '
                                    'И знаете, что еще делают трехлетние дети и собаки? '
                                    'Срут на ковер.'}  # Личная эффективность, мотивация
                    ]
